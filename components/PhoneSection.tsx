    ...
    <ParallaxProvider>
      ...
      <div className={styles.phoneSection}>
        <div className={cn(styles.sticky)}>
          ...
          <Parallax className={cn(styles.parallaxSquare, styles.square2)} speed={6}><div className={cn(styles.square, styles.mediumSquare)}><Image src="/images/square2.svg" layout="responsive" width="100%" height="100%" /></div></Parallax>
          <Parallax className={cn(styles.parallaxSquare, styles.square3)} speed={3}><div className={styles.square}><Image src="/images/square3.svg" layout="responsive" width="100%" height="100%" /></div></Parallax>
          <Parallax className={cn(styles.parallaxSquare, styles.square4)} speed={6}><div className={styles.square}><Image src="/images/square4.svg" layout="responsive" width="100%" height="100%" /></div></Parallax>
          <Parallax className={cn(styles.parallaxSquare, styles.square5)} speed={4}><div className={cn(styles.square, styles.largeSquare)}><Image src="/images/square5.svg" layout="responsive" width="100%" height="100%" /></div></Parallax>
          <Parallax className={cn(styles.parallaxSquare, styles.square6)} speed={4}><div className={cn(styles.square, styles.mediumSquare)}><Image src="/images/square6.svg" layout="responsive" width="100%" height="100%" /></div></Parallax>
          <Parallax className={cn(styles.parallaxSquare, styles.square7)} speed={3}><div className={styles.square}><Image src="/images/square7.svg" layout="responsive" width="100%" height="100%" /></div></Parallax>
